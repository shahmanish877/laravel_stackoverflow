                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('questions.update',$question) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" rows="5">{{ old('description',$question->description) }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
